...
namespace spec
{
	...
	public:
		...
		void TeststringMysteryCreate(){
			...
			Assert::AreEqual(true, areEqualStrings("?B\0", str), L"stringMysteryCreate() failed", 1, 2);

			str = stringMysteryCreate(9);
			Assert::AreEqual(true, areEqualStrings("012?E5678\0", str), L"stringMysteryCreate() failed", 1, 2);

			str = stringMysteryCreate(14);
			Assert::AreEqual(true, areEqualStrings("0123?56H89:;<=\0", str), L"stringMysteryCreate() failed", 1, 2);
		}
		...
		void TestnumberCharMystery(){
			...
			Assert::AreEqual(true, areEqualStrings("012\0-r", str), L"numberCharMystery() failed", 1, 2);

			strcopy(str, "hack-er");
			numberCharMystery(str);
			Assert::AreEqual(true, areEqualStrings("012\0-er", str), L"numberCharMystery() failed", 1, 2);

			strcopy(str, "program-mer");
			numberCharMystery(str);
			Assert::AreEqual(true, areEqualStrings("012\0ram-mer", str), L"numberCharMystery() failed", 1, 2);
		}
		...
		void TestabcMystery(){
			...
			abcMystery(str);
			Assert::AreEqual(true, areEqualStrings("0l1n2r\0ees", str), L"abcMystery() failed", 1, 2);

			strcopy(str, "vrukshaalu");
			abcMystery(str);
			Assert::AreEqual(true, areEqualStrings("0r1k2h\0alu", str), L"abcMystery() failed", 1, 2);
		}
        ...
        void TestconcatMystery(){
            ...
            b = "ALU";
            c = concatMystery(a, b);
            Assert::AreEqual(true, areEqualStrings("MMU\0ULA\0", c), L"abcMystery() failed", 1, 2);
            free(c);
            
            a = "thread";
            b = "lock";
            c = concatMystery(a, b);
            Assert::AreEqual(true, areEqualStrings("thread\0kcol\0", c), L"abcMystery() failed", 1, 2);
            free(c);
        }
